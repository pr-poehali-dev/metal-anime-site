...
const SPECS = [
  { label: "Материал", value: "Сталь 9CrSi + хром" },
  { label: "Твёрдость", value: "62 HRC" },
  { label: "Толщина", value: "4.5 мм" },
  { label: "Покрытие", value: "Нитрид титана" },
  { label: "Гравировка", value: "Лазер + ручная доводка" },
  { label: "Гарантия", value: "Пожизненная" },
];
...
const ADVANTAGES = [
  {
    icon: "Flame",
    title: "Закалка огнём",
    desc: "Каждое изделие проходит 7 этапов термообработки при температуре 1200°C",
    color: "#ff2d55",
  },
  {
    icon: "Zap",
    title: "Нано-острота",
    desc: "Геометрия клинка рассчитана AI и выполнена с точностью 0.01 мм",
    color: "#00f5ff",
  },
  {
    icon: "Shield",
    title: "Вечная прочность",
    desc: "Хромовое покрытие защищает от коррозии, царапин и ультрафиолета",
    color: "#f5a623",
  },
  {
    icon: "Star",
    title: "Арт-дизайн",
    desc: "Каждое изделие уникально — гравировка в стиле японской аниме-мифологии",
    color: "#b44fff",
  },
  {
    icon: "Award",
    title: "Ручная работа",
    desc: "Мастера с 20+ летним опытом. Сертификаты международных выставок",
    color: "#00f5ff",
  },
  {
    icon: "Package",
    title: "Подарочная упаковка",
    desc: "Деревянный кейс с шёлком и именной гравировкой в подарок",
    color: "#f5a623",
  },
];
...
const REVIEWS = [
  {
    ...
    role: "Коллекционер",
    rating: 5,
    text: "Это не просто изделие — это произведение искусства. Гравировка поражает детализацией, качество стали выше всяких похвал. Заказываю уже третий раз!",
    avatar: "⚔️",
  },
  {
    name: "Михаил Д.",
  ...
  },
  {
    ...
    role: "Геймер / косплей",
    rating: 5,
    text: "Брал для косплея, но вещь настолько хороша, что жалко использовать как реквизит. Поставил на витрину. Все гости в восторге.",
    avatar: "🎮",
  },
];
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              KATANA <span className="neon-text-gold">RYUU</span>
            </h2>
            <p style={{ color: "var(--steel)", maxWidth: "500px", margin: "0 auto" }}>
              «Дракон» — лимитированная серия ручной работы. Только 50 экземпляров в год.
            </p>
          </div>
            ...
            <div>
              ...
              >
                ...
                <p style={{ color: "var(--chrome)", lineHeight: "1.8" }}>
                  Katana Ryuu создана по технологии «дифференцированной закалки» — японский метод,
                  при котором режущая кромка твёрже обуха. Клинок из стали 9CrSi с уникальной
                  лазерной гравировкой дракона в стиле аниме-панк.
                </p>
              </div>
